package di.fa.kadevtools.core.exception;
...
public class KADevToolsException extends ServiceException {

    public KADevToolsException(HttpStatus statusCode, String errCode, String errMessage, SystemError systemError, Object... args){
        super(statusCode, null, null, errCode, errMessage, systemError, args);
    }

    public KADevToolsException(HttpStatus statusCode, String errCode, String errMessage, Object... args){
        super(statusCode, null, null, errCode, errMessage, args);
    }

    public KADevToolsException(HttpStatus statusCode, ResponseStatus status, SystemError systemError, Object... args){
        super(statusCode, null, null, status.getCode(), status.getMessage(), systemError, args);
    }

    public KADevToolsException(HttpStatus statusCode, ResponseStatus status, Object... args){
        super(statusCode, null, null, status.getCode(), status.getMessage(), args);
    }

    public KADevToolsException(HttpStatus statusCode, Throwable cause, ResponseStatus status, Object... args){
        super(statusCode, cause, null, status.getCode(), status.getMessage(), args);
    }

    public KADevToolsException(HttpStatus statusCode, Object error, ResponseStatus status, Object... args){
        super(statusCode, null, error, status.getCode(), status.getMessage(), args);
    }

    public KADevToolsException(HttpStatus statusCode, Object error, String errCode, String errMessage, Object... args){
        super(statusCode, null, error, errCode, errMessage, args);
    }

    public KADevToolsException(HttpStatus statusCode, SystemError systemError){
        super(statusCode, systemError);
    }

    public KADevToolsException(Set<? extends ConstraintViolation<?>> violations) {
