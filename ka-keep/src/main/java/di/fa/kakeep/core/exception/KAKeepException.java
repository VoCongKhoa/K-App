package di.fa.kakeep.core.exception;
...
public class KAKeepException extends ServiceException {

    public KAKeepException(HttpStatus statusCode, String errCode, String errMessage, SystemError systemError, Object... args){
        super(statusCode, null, null, errCode, errMessage, systemError, args);
    }

    public KAKeepException(HttpStatus statusCode, String errCode, String errMessage, Object... args){
        super(statusCode, null, null, errCode, errMessage, args);
    }

    public KAKeepException(HttpStatus statusCode, ResponseStatus status, SystemError systemError, Object... args){
        super(statusCode, null, null, status.getCode(), status.getMessage(), systemError, args);
    }

    public KAKeepException(HttpStatus statusCode, ResponseStatus status, Object... args){
        super(statusCode, null, null, status.getCode(), status.getMessage(), args);
    }

    public KAKeepException(HttpStatus statusCode, Throwable cause, ResponseStatus status, Object... args){
        super(statusCode, cause, null, status.getCode(), status.getMessage(), args);
    }

    public KAKeepException(HttpStatus statusCode, Object error, ResponseStatus status, Object... args){
        super(statusCode, null, error, status.getCode(), status.getMessage(), args);
    }

    public KAKeepException(HttpStatus statusCode, Object error, String errCode, String errMessage, Object... args){
        super(statusCode, null, error, errCode, errMessage, args);
    }

    public KAKeepException(HttpStatus statusCode, SystemError systemError){
        super(statusCode, systemError);
    }

    public KAKeepException(Set<? extends ConstraintViolation<?>> violations) {
